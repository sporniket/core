...
public class DataTools {
	...
	/**
	 * Verify that each byte of a buffer match the corresponding byte of a given
	 * sequence, starting from an offset.
	 * 
	 * @param sequence the sequence of bytes to match.
	 * @param buffer   the buffer to test.
	 * @param offset   the offset.
	 * @return <code>true</code> if the first bytes of buffer starting from offset
	 *         are the same as the provided sequence.
	 */
	 ...
	 * @param buffer   the buffer to test.
	 * @return <code>true</code> if the first bytes of buffer the same as the
	 *         provided sequence.
	 */
	...
	public static String convertToPaddedHexString(byte value) {
		...
		String hexString = Integer.toHexString(getUnsignedByteValue(value)).toLowerCase();
